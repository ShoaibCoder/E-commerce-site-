                            ...
                            <div className="container px-5 py-5 mx-auto ">
                                <div className="flex flex-wrap -m-4  justify-center">
                                    {filterProduct.length > 0
                                        ...
                                        <div>
                                            <div className="flex justify-center">
                                                <img className=" mb-2" src="https://www.breathearomatherapy.com/assets/images/global/no-product.png" alt="" height={'400px'} width={'400px'} />
                                            </div>
                                            <h1 className="flex justify-center text-black text-xl font-bold">No {categoryname} product found</h1>
                                        </div>
                                    }
                                </div>
                            </div>
...
//                                                             <div className="flex justify-center ">
//                                                                 <button className=" bg-indigo-500 hover:bg-indigo-600 w-full text-white py-[4px] rounded-lg font-bold">
//                                                                     Add To Cart
//                                                                 </button>
//                                                             </div>
//                                                         </div>
